...
const files = ['index.html','styles.css','app.js','songs.js','lyrics.js','lyrics.json','auto-scroll.js','wake-lock.js','fullscreen.js','sw.js','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png','icons/icon-maskable-512.png','icons/apple-touch-icon.png'];
await Promise.all(files.map(file => access(new URL(`../${file}`, import.meta.url))));
for (const file of ['app.js', 'songs.js', 'lyrics.js', 'auto-scroll.js', 'wake-lock.js', 'fullscreen.js', 'sw.js']) {
